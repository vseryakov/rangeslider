...
//  Copyright (c) 2013 Wyldfire. All rights reserved.
//
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    _bg = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"range-bg"]];
    _bg.frame = CGRectMake(0, frame.size.height/2 - _bg.frame.size.height/2, frame.size.width, _bg.frame.size.height);
    [self addSubview:_bg];
    
    _selected = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"range-selected"]];
